...
public class BalanceFeeAmountFragment extends Fragment{
    // Class Spinner....
    ...
    public BalanceFeeAmountFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View balanceFeeAmount = inflater.inflate(R.layout.balance_fee_amount_layout, container, false);
        // class spinner....
        classSpinner = (Spinner) balanceFeeAmount.findViewById(R.id.classSpinner);
        ...
        // section spinner....
        sectionSpinner = (Spinner) balanceFeeAmount.findViewById(R.id.sectionSpinner);
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Balance Fee Amount");

        return balanceFeeAmount;
    }
}
