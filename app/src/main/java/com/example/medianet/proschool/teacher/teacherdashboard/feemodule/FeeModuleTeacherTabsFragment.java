package com.example.medianet.proschool.teacher.teacherdashboard.feemodule;
...
public class FeeModuleTeacherTabsFragment extends Fragment {
    View timeTableView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        timeTableView = inflater.inflate(R.layout.fee_module_teacher_tabs_layout, container, false);
