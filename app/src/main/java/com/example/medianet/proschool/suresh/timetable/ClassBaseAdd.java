 ...
 */
public class ClassBaseAdd implements CalendarEvent {
     ...
     */
    public ClassBaseAdd(long id, int color, String title, String description, String location, long dateStart, long dateEnd, int allDay, String duration) {
        this.mId = id;
        this.mColor = color;
  ...
  //   * @param endTime The end time of the event.
     ...
     */
    public ClassBaseAdd(String title, String description, String location, int color, boolean allDay) {
        this.mTitle = title;
        this.mDescription = description;
        this.mLocation = location;
        this.mColor = color;
    ...
    public ClassBaseAdd(ClassBaseAdd calendarEvent) {
     ...
     * @param title The title of the event.
     */
    public ClassBaseAdd(Calendar day, String title) {
