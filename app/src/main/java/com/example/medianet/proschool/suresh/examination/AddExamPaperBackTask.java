...
public class AddExamPaperBackTask extends AsyncTask<String, Void, String>{

    Context mContext;

    public AddExamPaperBackTask(Context mContext){
    ...
    protected String doInBackground(String... params) {
        ...
        String json_url = Constants.addExamPaperUrl + subjectId + "/" + examId+"/"+classId+"/"+sectionId;
        try {
    ...
    protected void onPostExecute(String result) {
        if (result != null && !result.isEmpty() && result.equalsIgnoreCase("TRUE")){
            Toast.makeText(mContext, "New Exam Paper Added...!", Toast.LENGTH_LONG).show();
        }
    }
}
