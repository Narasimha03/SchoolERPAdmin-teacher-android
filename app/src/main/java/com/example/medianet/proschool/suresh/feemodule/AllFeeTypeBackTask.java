...
public class AllFeeTypeBackTask extends AsyncTask<String, Void, String> {

    Context mContext;
    AllFeeType allVehicle;

    public AllFeeTypeBackTask(Context mContext, AllFeeType allVehicle) {
        this.mContext = mContext;
        this.allVehicle = allVehicle;
    }

    public interface AllFeeType {
    ...
    protected String doInBackground(String... params) {
        ...
        String json_url = Constants.allFeeUrl + schoolId;
        try {
