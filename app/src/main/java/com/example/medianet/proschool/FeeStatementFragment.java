...
public class FeeStatementFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View feeStatementView = inflater.inflate(R.layout.fee_statement_layout, container, false);
        // class spinner....
        classSpinner = (Spinner) feeStatementView.findViewById(R.id.classSpinner);
        ...
        // section spinner....
        sectionSpinner = (Spinner) feeStatementView.findViewById(R.id.sectionSpinner);
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Fee Statement");
        return feeStatementView;
    }
}
