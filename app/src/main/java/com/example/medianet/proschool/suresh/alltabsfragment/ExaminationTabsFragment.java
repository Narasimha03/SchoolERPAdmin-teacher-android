...
public class ExaminationTabsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ExamPaperFragment addVehicleFragment = new ExamPaperFragment();

        viewPagerAdapter.addFrag(addVehicleFragment, "Papers");
        com.example.medianet.proschool.suresh.examination.ExamEvaluationFragment examEvaluationFragment1 = new com.example.medianet.proschool.suresh.examination.ExamEvaluationFragment();
        viewPagerAdapter.addFrag(examEvaluationFragment1, "Evaluations");
       com.example.medianet.proschool.suresh.examination.BulkEvaluationFragment bulkEvaluationFragment = new com.example.medianet.proschool.suresh.examination.BulkEvaluationFragment();
        viewPagerAdapter.addFrag(bulkEvaluationFragment, "Bulk Evaluations");
