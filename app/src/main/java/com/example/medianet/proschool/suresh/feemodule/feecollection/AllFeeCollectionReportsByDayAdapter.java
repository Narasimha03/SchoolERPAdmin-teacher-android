...
public class AllFeeCollectionReportsByDayAdapter extends RecyclerView.Adapter<AllFeeCollectionReportsByDayAdapter.ViewHolder>{

    Context mContext;
    List<FeeCollectionReports> evalMarksList;
    ArrayList<FeeCollectionReports> evalMarksArrayList;

    public AllFeeCollectionReportsByDayAdapter(Context mContext, ArrayList<FeeCollectionReports> evalMarksList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fee_collection_reports_day_list_layout, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (evalMarks != null){
            ...
            holder.fine.setText(evalMarks.getFine());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView student, feeType,totalFee, feePaid, paymentMode,discount, fine, balanceFee, dueDate,feePaidDate;
        public ViewHolder(View itemView) {
            ...
            fine = (TextView) itemView.findViewById(R.id.fineByDate);
