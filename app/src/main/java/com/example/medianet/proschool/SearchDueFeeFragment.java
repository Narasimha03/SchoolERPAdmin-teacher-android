...
public class SearchDueFeeFragment extends Fragment{
    // Class Spinner....
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View searchDueFeeView = inflater.inflate(R.layout.search_due_fee_layout, container, false);
        // class spinner....
        classSpinner = (Spinner) searchDueFeeView.findViewById(R.id.classSpinner);
        ...
        // section spinner....
        sectionSpinner = (Spinner) searchDueFeeView.findViewById(R.id.sectionSpinner);
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Search Due Fee");

        return searchDueFeeView;
    }
}
