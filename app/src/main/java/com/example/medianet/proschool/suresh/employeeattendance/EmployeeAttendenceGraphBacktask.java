...
public class EmployeeAttendenceGraphBacktask extends AsyncTask<String, Void, String> {

    Context mContext;
    AllStudentGraphs allStudentGraphs;

    public EmployeeAttendenceGraphBacktask(Context mContext, AllStudentGraphs allStudentGraphs) {
    ...
    protected String doInBackground(String... params) {
        ...
        String json_url = Constants.allemployeeAttendanceGraph + selectMonth+ "/" + schoolId;
        try {
