...
public class AddBulkMarksBackTask extends AsyncTask<String, Void, String> {
    Context mContext;
    public AddBulkMarksBackTask(Context mContext){
    ...
    protected String doInBackground(String... params) {
        ...
        String exmSchId = params[1];
        String exmPaperId = params[2];
        String sectionId = params[3];
        String classId = params[4];
        //String schoolId = params[3];
        String json_url = Constants.examMarksBulk + exmSchId + "/" + exmPaperId+"/"+sectionId+"/"+classId;
        try {
    ...
    protected void onPostExecute(String result) {
        ...
        {
            Toast.makeText(mContext, "marks already Added...!", Toast.LENGTH_LONG).show();
