...
public class StudentCustomAdapter extends RecyclerView.Adapter<StudentCustomAdapter.MyViewHolder> {
    ...
    private Context ctx;
    private StudentCustomAdapter.ItemClickStudentProfileListener itemClickStudentProfileListener;


    public StudentCustomAdapter(Context ctx, ArrayList<AttSubModel> imageModelArrayList) {
    ...
    @Override
    public StudentCustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.rv_item_student, parent, false);
    ...
    public void setClickListener(StudentCustomAdapter.ItemClickStudentProfileListener itemClickListener) {
        this.itemClickStudentProfileListener = itemClickListener;
    }
    @Override
    public void onBindViewHolder(final StudentCustomAdapter.MyViewHolder holder, int position) {
     ...
     /*  holder.addNo.setText(imageModelArrayList.get(position).getAdmNo());
        ...
        holder.presentAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  String checkboxPresent= ((CheckBox) v).getText().toString();
                AttSubModel attSubModel=new AttSubModel();
                attSubModel.setAttStatus(checkboxPresent);
                Log.e("present Status",checkboxPresent);*/
      ...
      //  holder.absentAll.setText("Absent");
    ...
    class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        ...
        private TextView rollNo,addNo,stdName;
        ...
        public MyViewHolder(View itemView) {
            ...
            stdName=(TextView)itemView.findViewById(R.id.name);
