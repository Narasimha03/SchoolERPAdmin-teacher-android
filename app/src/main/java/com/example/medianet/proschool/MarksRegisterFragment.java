...
public class MarksRegisterFragment extends Fragment{
    // Class Spinner....
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View marksRegisterView = inflater.inflate(R.layout.marks_register_layout, container, false);
        // class spinner....
        classSpinner = (Spinner) marksRegisterView.findViewById(R.id.classSpinner);
        ...
        // section spinner....
        sectionSpinner = (Spinner) marksRegisterView.findViewById(R.id.sectionSpinner);
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Marks Register");
        return marksRegisterView;
    }
}
