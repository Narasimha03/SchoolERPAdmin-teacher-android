...
public class TimeTableBackGroundTask extends AsyncTask<String, Void, String> {
    // Context
    Context mContext;
    ...
    public TimeTableBackGroundTask(Context mContext, OnTimeTableResponse onTimeTableResponse) {
    ...
    protected String doInBackground(String... params) {
        String json_string;
        String dayId = params[0];
        String classId = params[1];
        String json_url = Constants.timetableDayUrl + dayId + "/" + classId;
        try {
