...
public class ClassTimeTableFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View classTimeTableView = inflater.inflate(R.layout.class_timetable_layout, container, false);
        // class spinner....
        classSpinner = (Spinner) classTimeTableView.findViewById(R.id.classSpinner);
        ...
        // section spinner....
        sectionSpinner = (Spinner) classTimeTableView.findViewById(R.id.sectionSpinner);
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Class TimeTable");
