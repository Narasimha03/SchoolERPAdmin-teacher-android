...
public class AllStudentMonthGraphAdapter extends RecyclerView.Adapter<AllStudentMonthGraphAdapter.ViewHolder>{

    Context mContext;
    List<StudentGraphModel> evalMarksList;
    ArrayList<StudentGraphModel> evalMarksArrayList;

    public AllStudentMonthGraphAdapter(Context mContext, ArrayList<StudentGraphModel> evalMarksList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.student_attendance_list_graph_layout, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
      ...
      Glide.with(mContext)
        ...
        //    holder.mChart.setOnChartValueSelectedListener(mContext);
            ...
            holder. mChart.setVisibleYRangeMaximum(200, YAxis.AxisDependency.LEFT);
