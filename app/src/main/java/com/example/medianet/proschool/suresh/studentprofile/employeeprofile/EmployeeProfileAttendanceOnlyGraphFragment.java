...
import com.example.medianet.proschool.suresh.employeeattendancetabs.monthlyadapterandbacktask.EmpAttMonthlyBackTaskForGraph;
...
public class EmployeeProfileAttendanceOnlyGraphFragment extends Fragment implements

        EmpAttMonthlyBackTaskForGraph.AllEmpAttendanceByMonth {
...
String teacherId;
    ...
    public EmployeeProfileAttendanceOnlyGraphFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (role.equals("admin")) {
            new EmpAttMonthlyBackTaskForGraph(getActivity(), EmployeeProfileAttendanceOnlyGraphFragment.this).execute(employeeId);
        }
        else if (role.equals("teacher")) {
            new EmpAttMonthlyBackTaskForGraph(getActivity(), EmployeeProfileAttendanceOnlyGraphFragment.this).execute(teacherId);
        }
